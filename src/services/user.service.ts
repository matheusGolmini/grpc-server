...
export class UserService {
    ...
    createUser(
        call: grpc.ServerUnaryCall<CreateUserDto, UserDto>,
        callback: grpc.sendUnaryData<UserDto>
    ) {
    ...
    @ValidateDto(GetDto)
    getUser(
        call: grpc.ServerUnaryCall<GetDto, UserDto>,
        callback: grpc.sendUnaryData<UserDto>
    ) {
    ...
    updateUser(
        call: grpc.ServerUnaryCall<UpdateUserDto, UserDto>,
        callback: grpc.sendUnaryData<UserDto>
    ) {
    ...
    deleteUser(
        call: grpc.ServerUnaryCall<DeleteDto, EmptyDto>,
        callback: grpc.sendUnaryData<EmptyDto>
    ) {
        const { id } = call.request;
