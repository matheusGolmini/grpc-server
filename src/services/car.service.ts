...
export class CarService {
    ...
    createCar(
        call: grpc.ServerUnaryCall<CreateCarDto, CarDto>,
        callback: grpc.sendUnaryData<CarDto>
    ) {
    ...
    @ValidateDto(GetDto)
    getCar(
        call: grpc.ServerUnaryCall<GetDto, CarDto>,
        callback: grpc.sendUnaryData<CarDto>
    ) {
    ...
    updateCar(
        call: grpc.ServerUnaryCall<UpdateCarDto, CarDto>,
        callback: grpc.sendUnaryData<CarDto>
    ) {
